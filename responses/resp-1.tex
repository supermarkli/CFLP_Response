...
\begin{revcomment}{EModule Trust Model and Security} \label{comment:tcb-1}
...
Just like reviewer 2's comment \ref{comment:tlb-sidechannel-refine}, we have clarified this as a derivative advantage \S\ref{sec:tlb-side-channel} in paper's Section VI-A.
\end{revresponse}
